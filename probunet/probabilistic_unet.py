...
class ProbabilisticUnet(nn.Module):
    ...
    def __init__(self, input_channels, num_classes, num_filters=[32,64,128,192], latent_dim=6, no_convs_fcomb=4, beta=10.0):
    ...
    def sample(self, testing=False):
        ...
        """
        if testing == False:
            z_prior = self.prior_latent_space.rsample() # rsample means sampling using reparameterization trick
