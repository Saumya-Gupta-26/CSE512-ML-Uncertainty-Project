...
class UNet(nn.Module):
    def __init__(self, n_channels, n_classes, start_filters, bilinear=True):
        ...
        # M-heads
        self.outc1 = OutConv(start_filters, n_classes)
        self.outc2 = OutConv(start_filters, n_classes)
        self.outc3 = OutConv(start_filters, n_classes)
        self.outc4 = OutConv(start_filters, n_classes)
